...
*Modern cyber-themed landing page with feature overview*

### 📝 Registration
![Registration](screenshots/register.png)
*User registration with typing sample collection*

### 🎹 Typing Verification
![Typing Verification](screenshots/typing.png)
*Real-time typing verification with attempt tracking*

### 📊 Security Dashboard
![Security Dashboard](screenshots/security.png)
*Admin view of failed attempts and captured images*

### 📷 Captured Intruder
![Captured Image](screenshots/capture.png)
*Webcam capture viewer for suspicious attempts*
